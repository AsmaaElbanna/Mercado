...
public class LaptopBagAdapter extends RecyclerView.Adapter<LaptopBagAdapter.ViewHolder> {

    private final Context context;
    private List<LaptopBag> models;

    public LaptopBagAdapter(Context context, List<LaptopBag> models) {
