...
public class HomeApplianceAdapter extends RecyclerView.Adapter<HomeApplianceAdapter.ViewHolder> {

    private final Context context;
    private List<HomeAppliance> models;

    public HomeApplianceAdapter(Context context, List<HomeAppliance> models) {
