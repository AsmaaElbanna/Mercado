...
public class KidsClothingAdapter extends RecyclerView.Adapter<KidsClothingAdapter.ViewHolder>{
    private final Context context;
    private List<KidsClothing> models;

    public KidsClothingAdapter(Context context, List<KidsClothing> models) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull KidsClothingAdapter.ViewHolder holder, int position) {
