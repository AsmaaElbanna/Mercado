...
public class WomenBagsAdapter extends RecyclerView.Adapter<WomenBagsAdapter.ViewHolder>{
    private final Context context;
    private List<WomenBags> models;

    public WomenBagsAdapter(Context context, List<WomenBags> models) {
